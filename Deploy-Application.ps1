...
Try {
	...
	[string]$appName = 'Sketchbook'
	[string]$appVersion = '8.7.1.0'
	[string]$appArch = 'x64'
	[string]$appLang = 'EN'
	[string]$appRevision = '01'
	[string]$appScriptVersion = '3.7.0.1'
	[string]$appScriptDate = '11/13/2018'
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		Show-InstallationWelcome -CloseApps 'sketchbook' -CheckDiskSpace -PersistPrompt

		## Show Progress Message (with the default message)
		Show-InstallationProgress

		## <Perform Pre-Installation tasks here>
		If (Test-Path -path "$envProgramFiles\Autodesk\Sketchbook\Sketchbook.exe") {
		  Remove-MSIApplications -Name "Autodesk Sketchbook" -PassThru
		}
		...
		Execute-Process -Path "$dirfiles/setup.bat" -Parameters 'silent-noshortcut' -WaitForMsiExec:$true
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		Show-InstallationWelcome -CloseApps 'sketchbook' -CloseAppsCountdown 60
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAY5+/S7ad0BGD5
# P4qQYezfHYpHPFWsu0lvpk/lTLAUf6CCFFwwggQUMIIC/KADAgECAgsEAAAAAAEv
...
# BgEEAYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgcJc4HAVF
# 1APqGMUJHHegFbIF+Ujq0Zk7rEFFG/QJCtUwDQYJKoZIhvcNAQEBBQAEggEAC6lt
# 5qpueCtVNKvVhWA7SVoTtP7gTEQPgVrj/Y8nzqF3smZ3zrHwsDsmwiSnxPhdCsDV
# QQhXr1hbff7GXydOncgKFkr9gN8Fl0hiVQ/Pg002goUgGw56uTAQwVDLeFatojS1
# dJBmoYg2BbDttdPmorJWC1OXBu48OVHe31fhkrroFxUdoNGtucx5oTu90kjFFCef
# 2EfmF+kNMRL382mrXlKArRyB6Kj01oiNvE3sCQRwz+3Te6rPU7e440a3qLTuEjtM
# 4cS7uP7GqOH86IFJCohgV4PnQ4ous0pGB2T4ez65EC4WXaHqSkLQkqdOKGumu9Zg
# aY9iTK835hXiUy4CFaGCAqIwggKeBgkqhkiG9w0BCQYxggKPMIICiwIBATBoMFIx
...
# CSqGSIb3DQEJBTEPFw0xOTEyMDIyMTA3MDdaMCMGCSqGSIb3DQEJBDEWBBQUhi/v
# zZ0lh9pcFkSRee6DIaHmiDCBnQYLKoZIhvcNAQkQAgwxgY0wgYowgYcwgYQEFGO4
...
# ggEARL4w41TCkBZsxkQYDyZTH7TsUftkmpZVz0AvmZI90LEIuRmg8hbQ9GZHG60g
# OxTJSPHgIbqriotC2ilUwXH/MJIJrpDfvxqaycZzTfRRRcZbTk7fCq9JUe9Bsy6U
# 7pN2vhjnQVMGs0QSzpTnNeq5KkJ5f5bpdb5IVwOe699Ic46U7xd01g3JpHLRLh+X
# VTejCG2KzOLMuj6BLoHdeApKFiSOMPCeEAkoRLFrbgRse9r9E9UXJf24mPNflxjA
# ZX+BX/N0+Q/eYE6acQ6tvQ7nEG0/MDtYCvotRrpltkHlg7nbGs4OvD7xZwj/dphq
# bDAb1hqoF644oyUM+BSXQVX+2w==
